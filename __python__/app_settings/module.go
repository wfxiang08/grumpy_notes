...
var Code *πg.Code
func init() {
	Code = πg.NewCode("<module>", "__python__/app_settings/module.py", nil, 0, func(πF *πg.Frame, _ []*πg.Object) (*πg.Object, *πg.BaseException) {
		...
		for ; πF.State() >= 0; πF.PopCheckpoint() {
			...
			// line 1: from hello import hello, get_key_value
			πF.SetLineno(1)
			if πTemp002, πE = πg.ImportModule(πF, "hello"); πE != nil {
				continue
			}
			πTemp001 = πTemp002[0]
